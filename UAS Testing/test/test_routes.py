...
def create_test_cart(cart_id):
    cart = Cart(id=cart_id, coupon_code='SAMPLE_COUPON', shipping_fee=200000.0, subtotal=35000.0, grand_total=150000.0)
    cart_item = CartItem(product_id=1, qty=2, item_price=35000.0)
